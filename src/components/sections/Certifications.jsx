  ...
  return (
    <section>
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-xl font-semibold flex items-center gap-2"><Shield className="w-5 h-5 text-indigo-600 dark:text-cyan-400" /> Certifications</h3>
        <div className="flex gap-2">
          <button onClick={prev} className="p-2 rounded-md border border-slate-200/60 dark:border-slate-800 bg-white/60 dark:bg-slate-900/60 hover:bg-white hover:dark:bg-slate-900" aria-label="Previous">
            <ArrowLeft className="w-4 h-4" />
          </button>
          <button onClick={next} className="p-2 rounded-md border border-slate-200/60 dark:border-slate-800 bg-white/60 dark:bg-slate-900/60 hover:bg-white hover:dark:bg-slate-900" aria-label="Next">
            <ArrowRight className="w-4 h-4" />
          </button>
        </div>
      </div>
      <div className="relative grid md:grid-cols-2 gap-6 items-stretch">
        <div className="relative h-64 md:h-72 rounded-lg overflow-hidden border border-slate-200/60 dark:border-slate-800">
        ...
        <div className="rounded-lg border border-slate-200/60 dark:border-slate-800 p-4 bg-white/50 dark:bg-slate-900/40">
          ...
          <div className="mt-4 text-xs text-slate-500 dark:text-slate-400">Slide {index + 1} of {CERTS.length}</div>
        </div>
      </div>
    </section>
  );
